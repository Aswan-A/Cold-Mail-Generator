...
class Chain:
    ...
    def write_mail(self, job, links,name,company):
        prompt_email = PromptTemplate.from_template(
            ...
            Remember you are {name}, BDE at {company}. 
        ...
        res = chain_email.invoke({"job_description": str(job), "link_list": links,"name":name,"company":company})
        return res.content
